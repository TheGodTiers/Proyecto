...
INSERT INTO `libros` VALUES (1000,'La máquina del tiempo','La trama principal gira en torno a un caballero victoriano y sus teorías sobre los viajes en el tiempo . Para demostrarlas, construye una máquina y viaja 800.000 años hacia el futuro, donde entabla amistad con un grupo de personas, los Eloi, descendientes de los humanos modernos.',30000.00,5700.00,320),(1001,'En las montañas de la locura','narra una expedición al Ártico que descubre los restos de una civilización extraterrestre inteligente, aún desconocida, anterior a la vida humana en la Tierra ',70000.00,13300.00,240),(1002,'Las estrellas, mi destino','Narra la historia de Gulliver Foyle, un hombre sin ambiciones ni rumbo, que es abandonado en una nave espacial averiada y, a causa de su propia rabia y una serie de contratiempos, se reinventa como aristócrata en una sociedad destrozada por la invención de la teletransportación para acechar a quienes le hicieron daño.',300000.00,57000.00,94),(1003,'El señor de los anillos','novela épica de fantasía escrita por J.R.R. Tolkien que narra la aventura de Frodo Bolsón y sus amigos para destruir el Anillo Único',315000.00,59850.00,525),(1004,'La rueda del tiempo','narra la búsqueda de un grupo de jóvenes que podrían ser la reencarnación del Dragón Renacido',400000.00,76000.00,100),(1005,'Orgullo Y Prejuicio','La aparición en Longbourn, un pueblo de la campiña inglesa, de Charles Bingley, joven, soltero y rico, despierta las ambiciones de las familias del vecindario, que lo consideran un excelente partido para sus hijas.',123000.00,23370.00,60),(1006,'Dispersión','Reid nos cuenta la historia de Penny, una anciana que vive sola, sufre un accidente doméstico y cuando despierta se encuentra en la residencia Seis Cedros. Un lugar muy grande, pero que solo acoge a otros tres ancianos: Peter, Hilbert y Ruth. Penny se siente enseguida bien tratada y acogida pero hay varias cosas que la inquietan.',85000.00,16150.00,79),(1007,'Los 13 exorcismos de Salomon Joch','El padre Salomon Joch, exorcista al servicio del Vaticano ha sido bendecido (o maldecido quizás) con el don de la inmortalidad. Por su faceta de exorcista inmortal, ha vivido cosas que la mayoría ni siquiera alcanza a imaginar. Una lectura fresca, en la que acompañamos a este peculiar sacerdote en trece exorcismos escalofriantes a través de los tiempos.',189000.00,35910.00,130),(1008,'Romeo y Julieta','cuenta la historia de dos jóvenes enamorados, Romeo Montesco y Julieta Capuleto, cuyas familias están en guerra, lo que conduce a una tragedia fatal',40000.00,7600.00,890);
...
INSERT INTO `pedido_detalle` VALUES (1,1,1000,5,30000.00,5700.00),(2,1,1001,2,70000.00,13300.00);
...
INSERT INTO `pedidos` VALUES (1,100001,'2025-04-07 20:30:37',345100.00);
...
-- Dump completed on 2025-04-07 16:52:19
